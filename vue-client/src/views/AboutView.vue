    ...
    <section class="py-5" style="background-color: #E0F1F5;">
      ...
      <div class="d-flex justify-content-between">
        <div class="py-4 my-2">
          ...
          <p class="text-center py-2">Rebecca Morel</p>
        </div>
        <div class="py-4 my-2">
          <img src="./../assets/images/avatar-team-test.png" height="150" width="200" class="rounded-circle my-2">
          <p class="text-center py-2">Victor Léonard</p>
        </div>
        <div class="py-4 my-2">
          <img src="./../assets/images/avatar-team-test.png" height="150" width="200" class="rounded-circle my-2">
         <p class="text-center py-2">Louis Giraud</p>
        </div>
        <div class="py-4 my-2">
          <img src="./../assets/images/avatar-team-test.png" height="150" width="200" class="rounded-circle my-2">
         <p class="text-center py-2">Bixente Sehabiague</p>
        </div>
      </div>
    </div>
    </section>
